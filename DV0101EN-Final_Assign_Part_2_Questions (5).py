...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        ue_rate = average_sales.groupby('Unemployment_Rate')['Automobile_Sales'].mean().reset_index()
        R_chart4 = dcc.Graph(
            figure=px.bar(ue_rate,
    ...
    elif selected_statistics == 'Yearly Statistics report':
...
#plot 1 Yearly Automobile sales using line chart for the whole period.
        ...
        Y_chart1 = dcc.Graph(
            figure=px.line(
                ...
                x='Year',
                y='Automobile_Sales',
                title='Average Automobile Sales Over Period'
            ))
...
# Plot 2 Total Monthly Automobile sales using line chart.
        ...
        Y_chart2 = dcc.Graph(
            figure=px.line(
                ...
                x='Month',
                y='Automobile_Sales',
                title='Total Monthy Automobile Sales'
            ))
